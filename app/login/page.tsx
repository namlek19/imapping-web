      ...
      <div className="w-full max-w-sm bg-white rounded-3xl shadow-sm px-8 py-10 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-1">
          <button
            type="button"
            disabled
            className="w-full flex items-center justify-center gap-3 rounded-xl border border-gray-200 bg-gray-50 py-2.5 text-sm font-medium text-gray-400 cursor-not-allowed opacity-60"
          >
          ...
          <p className="text-center text-xs text-gray-400">Tính năng đang phát triển</p>
        </div>
